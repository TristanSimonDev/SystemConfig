...
for /r "C:\Windows\prefetch\" %%i in (*) do ( 
...
echo Prefetch Option (3) >> %original_cd%\src\User\Backend\log\log.txt [has been Activated on ~ %date% at %time:~0,5%] [!counter! files got Terminated]
echo.
